...
fit_quad <- nlme(Speed~model_quad(Temp, a, b, c),
                 ...
                 random = list(Mother=pdDiag(list(a~1,b~1,c~1))),
...
fit_skewedgauss <- nlme(Speed~model_skewedgauss(Temp, a, b, c, d),
                        ...
                        random = list(Mother=pdDiag(list(a~1,b~1,c~1,d~1))),
...
fit_logan6 <- nlme(Speed~model_logan6(Temp, psi, rho, dt, tm),
                  ...
                  random = list(Mother=pdDiag(list(psi~1,rho~1,dt~1,tm~1))),
...
fit_logan10 <- nlme(Speed~model_logan10(Temp, alpha, k, rho, dt, tm),
                    ...
                    random = list(Mother=pdDiag(list(alpha~1,k~1,rho~1,dt~1,tm~1))),
...
coefs <- data.frame(Quad=coef(fit_quad),
  ...
  gather(Mother, Val, -c(Model, Coef)) %>%
  group_by(Model, Coef) %>%
